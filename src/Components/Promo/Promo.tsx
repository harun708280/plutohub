  ...
  return (
    <section className="pomo_area sec_padding">
      ...
      <Container>
        <Row>
          <Col md={6}>
            <div className="promo_img text-center" ref={promoImgRef}>
              <svg
                width="450"
                height="421"
                viewBox="0 0 450 421"
          ...
          <Col md={6}>
            <div className="promo_content">
              ...
              <p>
                ...
                intuitive digital experiences. With years of experience, we blend
                creativity and strategy to design solutions that engage users and
                drive business success.
              </p>
              <p>
                We turn ideas into seamless, beautiful designs. Let’s build digital
